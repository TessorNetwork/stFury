...
LOCALDRED_HOME=./testutil/localdred
LOCALNET_COMPOSE_FILE=$(LOCALDRED_HOME)/localnet/docker-compose.yml
STATE_EXPORT_COMPOSE_FILE=$(LOCALDRED_HOME)/state-export/docker-compose.yml
...
localnet-keys:
	. $(LOCALDRED_HOME)/localnet/add_keys.sh
