...
LOCALDREDGER_HOME=./testutil/localdredger
LOCALNET_COMPOSE_FILE=$(LOCALDREDGER_HOME)/localnet/docker-compose.yml
STATE_EXPORT_COMPOSE_FILE=$(LOCALDREDGER_HOME)/state-export/docker-compose.yml
...
localnet-keys:
	. $(LOCALDREDGER_HOME)/localnet/add_keys.sh
