...
// source: dredger/stakeibc/min_validator_requirements.proto
...
func init() {
	proto.RegisterType((*MinValidatorRequirements)(nil), "dredger.stakeibc.MinValidatorRequirements")
}

func init() {
	proto.RegisterFile("dredger/stakeibc/min_validator_requirements.proto", fileDescriptor_c53a743ee7ad112e)
}
