...
// source: dredger/stakeibc/params.proto
...
// next id: 18
type Params struct {
	// define epoch lengths, in dred_epochs
	...
	DredCommission       uint64 `protobuf:"varint,4,opt,name=dred_commission,json=dredCommission,proto3" json:"dred_commission,omitempty"`
...
func (m *Params) GetDredCommission() uint64 {
	if m != nil {
		return m.DredCommission
	}
	return 0
}
...
func init() {
	proto.RegisterType((*Params)(nil), "dredger.stakeibc.Params")
	proto.RegisterMapType((map[string]string)(nil), "dredger.stakeibc.Params.ZoneComAddressEntry")
}

func init() { proto.RegisterFile("dredger/stakeibc/params.proto", fileDescriptor_5aeaab6a38c2b438) }
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.DredCommission != 0 {
		i = encodeVarintParams(dAtA, i, uint64(m.DredCommission))
		i--
		dAtA[i] = 0x20
	}
...
func (m *Params) Size() (n int) {
	...
	if m.DredCommission != 0 {
		n += 1 + sovParams(uint64(m.DredCommission))
	}
	if len(m.ZoneComAddress) > 0 {
...
func (m *Params) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field DredCommission", wireType)
			}
			m.DredCommission = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.DredCommission |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
