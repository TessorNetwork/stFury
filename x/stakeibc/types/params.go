...
var (
	...
	DefaultDredgerCommission                 uint64 = 10
	...
	KeyDredgerCommission                 = []byte("DredgerCommission")
...
func NewParams(
	...
	return Params{
		...
		DredgerCommission:                 dredgerCommission,
...
func (p *Params) ParamSetPairs() paramtypes.ParamSetPairs {
	return paramtypes.ParamSetPairs{
		...
		paramtypes.NewParamSetPair(KeyDredgerCommission, &p.DredgerCommission, isCommission),
