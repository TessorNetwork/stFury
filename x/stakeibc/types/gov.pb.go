...
// source: dredger/stakeibc/gov.proto
...
func init() {
	proto.RegisterType((*AddValidatorProposal)(nil), "dredger.stakeibc.AddValidatorProposal")
}

func init() { proto.RegisterFile("dredger/stakeibc/gov.proto", fileDescriptor_8204317b384c5680) }
