...
// source: dredger/stakeibc/ica_account.proto
...
type ICAAccount struct {
	...
	Target  ICAAccountType `protobuf:"varint,3,opt,name=target,proto3,enum=dredger.stakeibc.ICAAccountType" json:"target,omitempty"`
}
...
func init() {
	proto.RegisterEnum("dredger.stakeibc.ICAAccountType", ICAAccountType_name, ICAAccountType_value)
	proto.RegisterType((*ICAAccount)(nil), "dredger.stakeibc.ICAAccount")
}

func init() { proto.RegisterFile("dredger/stakeibc/ica_account.proto", fileDescriptor_2976ae6e7f6ce824) }
