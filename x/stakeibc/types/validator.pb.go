...
// source: dredger/stakeibc/validator.proto
...
type Validator struct {
	...
	Status               Validator_ValidatorStatus              `protobuf:"varint,3,opt,name=status,proto3,enum=dredger.stakeibc.Validator_ValidatorStatus" json:"status,omitempty"`
...
func init() {
	proto.RegisterEnum("dredger.stakeibc.Validator_ValidatorStatus", Validator_ValidatorStatus_name, Validator_ValidatorStatus_value)
	proto.RegisterType((*ValidatorExchangeRate)(nil), "dredger.stakeibc.ValidatorExchangeRate")
	proto.RegisterType((*Validator)(nil), "dredger.stakeibc.Validator")
}

func init() { proto.RegisterFile("dredger/stakeibc/validator.proto", fileDescriptor_5d2f32e16bd6ab8f) }
