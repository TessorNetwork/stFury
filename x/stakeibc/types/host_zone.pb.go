...
// source: dredger/stakeibc/host_zone.proto
...
func init() {
	proto.RegisterType((*HostZone)(nil), "dredger.stakeibc.HostZone")
}

func init() { proto.RegisterFile("dredger/stakeibc/host_zone.proto", fileDescriptor_f81bf5b42c61245a) }
