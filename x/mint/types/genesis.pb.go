...
// source: dredger/mint/v1beta1/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "dredger.mint.v1beta1.GenesisState")
}

func init() { proto.RegisterFile("dredger/mint/v1beta1/genesis.proto", fileDescriptor_f4521d63f51851f3) }
