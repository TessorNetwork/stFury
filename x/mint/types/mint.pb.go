...
// source: dredger/mint/v1beta1/mint.proto
...
func init() {
	proto.RegisterType((*Minter)(nil), "dredger.mint.v1beta1.Minter")
	proto.RegisterType((*DistributionProportions)(nil), "dredger.mint.v1beta1.DistributionProportions")
	proto.RegisterType((*Params)(nil), "dredger.mint.v1beta1.Params")
}

func init() { proto.RegisterFile("dredger/mint/v1beta1/mint.proto", fileDescriptor_5ad5fa4b1fdb702f) }
