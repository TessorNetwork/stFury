...
// source: dredger/interchainquery/v1/messages.proto
...
func init() {
	proto.RegisterType((*MsgSubmitQueryResponse)(nil), "dredger.interchainquery.v1.MsgSubmitQueryResponse")
	proto.RegisterType((*MsgSubmitQueryResponseResponse)(nil), "dredger.interchainquery.v1.MsgSubmitQueryResponseResponse")
}

func init() {
	proto.RegisterFile("dredger/interchainquery/v1/messages.proto", fileDescriptor_25adad4f8ed32400)
}
...
func (c *msgClient) SubmitQueryResponse(ctx context.Context, in *MsgSubmitQueryResponse, opts ...grpc.CallOption) (*MsgSubmitQueryResponseResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/dredger.interchainquery.v1.Msg/SubmitQueryResponse", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_SubmitQueryResponse_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dredger.interchainquery.v1.Msg/SubmitQueryResponse",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "dredger.interchainquery.v1.Msg",
	...
	Metadata: "dredger/interchainquery/v1/messages.proto",
}
