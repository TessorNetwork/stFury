...
// source: dredger/interchainquery/v1/query.proto
...
func init() {
	proto.RegisterType((*QueryPendingQueriesRequest)(nil), "dredger.interchainquery.v1.QueryPendingQueriesRequest")
	proto.RegisterType((*QueryPendingQueriesResponse)(nil), "dredger.interchainquery.v1.QueryPendingQueriesResponse")
}

func init() {
	proto.RegisterFile("dredger/interchainquery/v1/query.proto", fileDescriptor_b720c147b9144d5b)
}
...
var fileDescriptor_b720c147b9144d5b = []byte{
	...
	0x68, 0x38, 0x05, 0x9d, 0x78, 0x24, 0xc7, 0x78, 0xe1, 0x91, 0x1c, 0xe3, 0x83, 0x47, 0x72, 0x8c,
	0x13, 0x1e, 0xcb, 0x31, 0x5c, 0x78, 0x2c, 0xc7, 0x70, 0xe3, 0xb1, 0x1c, 0x43, 0x94, 0x45, 0x7a,
	0x66, 0x49, 0x46, 0x69, 0x92, 0x5e, 0x72, 0x7e, 0x2e, 0x36, 0x83, 0xcb, 0x4c, 0xf4, 0x2b, 0x30,
	0x4c, 0x2f, 0xa9, 0x2c, 0x48, 0x2d, 0x4e, 0x62, 0x03, 0x47, 0x9c, 0x31, 0x20, 0x00, 0x00, 0xff,
	0xff, 0xcf, 0x30, 0xb6, 0x38, 0x59, 0x02, 0x00, 0x00,
}
...
func (c *queryServiceClient) PendingQueries(ctx context.Context, in *QueryPendingQueriesRequest, opts ...grpc.CallOption) (*QueryPendingQueriesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/dredger.interchainquery.v1.QueryService/PendingQueries", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _QueryService_PendingQueries_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dredger.interchainquery.v1.QueryService/PendingQueries",
	}
...
var _QueryService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "dredger.interchainquery.v1.QueryService",
	...
	Metadata: "dredger/interchainquery/v1/query.proto",
}
