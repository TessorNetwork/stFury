...
// source: dredger/interchainquery/v1/genesis.proto
...
func init() {
	proto.RegisterType((*Query)(nil), "dredger.interchainquery.v1.Query")
	proto.RegisterType((*DataPoint)(nil), "dredger.interchainquery.v1.DataPoint")
	proto.RegisterType((*GenesisState)(nil), "dredger.interchainquery.v1.GenesisState")
}

func init() {
	proto.RegisterFile("dredger/interchainquery/v1/genesis.proto", fileDescriptor_74cd646eb05658fd)
}
