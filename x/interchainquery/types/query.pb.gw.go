...
var (
	pattern_QueryService_PendingQueries_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"TessorNetwork", "dredger", "interchainquery", "pending_queries"}, "", runtime.AssumeColonVerbOpt(false)))
)
