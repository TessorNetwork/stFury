...
// DredgerPeriodicVestingAccount implements the VestingAccount interface. It
// periodically vests by unlocking coins during each specified period.
type DredgerPeriodicVestingAccount struct {
...
func (m *DredgerPeriodicVestingAccount) Reset()      { *m = DredgerPeriodicVestingAccount{} }
func (*DredgerPeriodicVestingAccount) ProtoMessage() {}
func (*DredgerPeriodicVestingAccount) Descriptor() ([]byte, []int) {
	return fileDescriptor_41f0278a453c26b3, []int{2}
}
func (m *DredgerPeriodicVestingAccount) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *DredgerPeriodicVestingAccount) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_DredgerPeriodicVestingAccount.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *DredgerPeriodicVestingAccount) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DredgerPeriodicVestingAccount.Merge(m, src)
}
func (m *DredgerPeriodicVestingAccount) XXX_Size() int {
	return m.Size()
}
func (m *DredgerPeriodicVestingAccount) XXX_DiscardUnknown() {
	xxx_messageInfo_DredgerPeriodicVestingAccount.DiscardUnknown(m)
}

var xxx_messageInfo_DredgerPeriodicVestingAccount proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*DredgerPeriodicVestingAccount)(nil), "dredger.vesting.DredgerPeriodicVestingAccount")
}
...
func (m *DredgerPeriodicVestingAccount) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *DredgerPeriodicVestingAccount) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *DredgerPeriodicVestingAccount) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *DredgerPeriodicVestingAccount) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *DredgerPeriodicVestingAccount) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: DredgerPeriodicVestingAccount: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: DredgerPeriodicVestingAccount: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
