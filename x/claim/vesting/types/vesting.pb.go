...
// DredPeriodicVestingAccount implements the VestingAccount interface. It
// periodically vests by unlocking coins during each specified period.
type DredPeriodicVestingAccount struct {
...
func (m *DredPeriodicVestingAccount) Reset()      { *m = DredPeriodicVestingAccount{} }
func (*DredPeriodicVestingAccount) ProtoMessage() {}
func (*DredPeriodicVestingAccount) Descriptor() ([]byte, []int) {
	return fileDescriptor_41f0278a453c26b3, []int{2}
}
func (m *DredPeriodicVestingAccount) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *DredPeriodicVestingAccount) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_DredPeriodicVestingAccount.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *DredPeriodicVestingAccount) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DredPeriodicVestingAccount.Merge(m, src)
}
func (m *DredPeriodicVestingAccount) XXX_Size() int {
	return m.Size()
}
func (m *DredPeriodicVestingAccount) XXX_DiscardUnknown() {
	xxx_messageInfo_DredPeriodicVestingAccount.DiscardUnknown(m)
}

var xxx_messageInfo_DredPeriodicVestingAccount proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*DredPeriodicVestingAccount)(nil), "dredger.vesting.DredPeriodicVestingAccount")
}
...
func (m *DredPeriodicVestingAccount) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *DredPeriodicVestingAccount) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *DredPeriodicVestingAccount) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *DredPeriodicVestingAccount) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *DredPeriodicVestingAccount) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: DredPeriodicVestingAccount: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: DredPeriodicVestingAccount: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
