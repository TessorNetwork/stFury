...
var (
	...
	_ vestexported.VestingAccount = (*DredPeriodicVestingAccount)(nil)
)
...
var _ vestexported.VestingAccount = (*DredPeriodicVestingAccount)(nil)
var _ authtypes.GenesisAccount = (*DredPeriodicVestingAccount)(nil)

// NewDredPeriodicVestingAccountRaw creates a new DredPeriodicVestingAccount object from BaseVestingAccount
func NewDredPeriodicVestingAccountRaw(bva *BaseVestingAccount, startTime int64, periods Periods) *DredPeriodicVestingAccount {
	return &DredPeriodicVestingAccount{
		BaseVestingAccount: bva,
		VestingPeriods:     periods,
	}
}

// NewDredPeriodicVestingAccount returns a new DredPeriodicVestingAccount
func NewDredPeriodicVestingAccount(baseAcc *authtypes.BaseAccount, originalVesting sdk.Coins, periods Periods) *DredPeriodicVestingAccount {
	if len(periods) == 0 {
		return &DredPeriodicVestingAccount{}
	}
...
func (pva *DredPeriodicVestingAccount) AddNewGrant(grantedPeriod Period) {
...
// nil is returned.
func (pva DredPeriodicVestingAccount) GetVestedCoins(blockTime time.Time) sdk.Coins {
...
func (pva DredPeriodicVestingAccount) GetVestingCoins(blockTime time.Time) sdk.Coins {
	return pva.OriginalVesting.Sub(pva.GetVestedCoins(blockTime)...)
}

// LockedCoins returns the set of coins that are not spendable (i.e. locked),
// defined as the vesting coins that are not delegated.
func (pva DredPeriodicVestingAccount) LockedCoins(blockTime time.Time) sdk.Coins {
...
func (pva *DredPeriodicVestingAccount) TrackDelegation(blockTime time.Time, balance, amount sdk.Coins) {
...
// account.
func (pva DredPeriodicVestingAccount) GetStartTime() int64 {
	return pva.VestingPeriods[0].StartTime
}

// GetVestingPeriods returns vesting periods associated with periodic vesting account.
func (pva DredPeriodicVestingAccount) GetVestingPeriods() Periods {
	return pva.VestingPeriods
}

// Validate checks for errors on the account fields
func (pva DredPeriodicVestingAccount) Validate() error {
...
func (pva DredPeriodicVestingAccount) String() string {
	out, _ := pva.MarshalYAML()
	return out.(string)
}

// MarshalYAML returns the YAML representation of a DredPeriodicVestingAccount.
func (pva DredPeriodicVestingAccount) MarshalYAML() (interface{}, error) {
