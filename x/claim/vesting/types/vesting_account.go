...
var (
	...
	_ vestexported.VestingAccount = (*DredgerPeriodicVestingAccount)(nil)
)
...
var _ vestexported.VestingAccount = (*DredgerPeriodicVestingAccount)(nil)
var _ authtypes.GenesisAccount = (*DredgerPeriodicVestingAccount)(nil)

// NewDredgerPeriodicVestingAccountRaw creates a new DredgerPeriodicVestingAccount object from BaseVestingAccount
func NewDredgerPeriodicVestingAccountRaw(bva *BaseVestingAccount, startTime int64, periods Periods) *DredgerPeriodicVestingAccount {
	return &DredgerPeriodicVestingAccount{
		BaseVestingAccount: bva,
		VestingPeriods:     periods,
	}
}

// NewDredgerPeriodicVestingAccount returns a new DredgerPeriodicVestingAccount
func NewDredgerPeriodicVestingAccount(baseAcc *authtypes.BaseAccount, originalVesting sdk.Coins, periods Periods) *DredgerPeriodicVestingAccount {
	if len(periods) == 0 {
		return &DredgerPeriodicVestingAccount{}
	}
...
func (pva *DredgerPeriodicVestingAccount) AddNewGrant(grantedPeriod Period) {
...
// nil is returned.
func (pva DredgerPeriodicVestingAccount) GetVestedCoins(blockTime time.Time) sdk.Coins {
...
func (pva DredgerPeriodicVestingAccount) GetVestingCoins(blockTime time.Time) sdk.Coins {
	return pva.OriginalVesting.Sub(pva.GetVestedCoins(blockTime)...)
}

// LockedCoins returns the set of coins that are not spendable (i.e. locked),
// defined as the vesting coins that are not delegated.
func (pva DredgerPeriodicVestingAccount) LockedCoins(blockTime time.Time) sdk.Coins {
...
func (pva *DredgerPeriodicVestingAccount) TrackDelegation(blockTime time.Time, balance, amount sdk.Coins) {
...
// account.
func (pva DredgerPeriodicVestingAccount) GetStartTime() int64 {
	return pva.VestingPeriods[0].StartTime
}

// GetVestingPeriods returns vesting periods associated with periodic vesting account.
func (pva DredgerPeriodicVestingAccount) GetVestingPeriods() Periods {
	return pva.VestingPeriods
}

// Validate checks for errors on the account fields
func (pva DredgerPeriodicVestingAccount) Validate() error {
...
func (pva DredgerPeriodicVestingAccount) String() string {
	out, _ := pva.MarshalYAML()
	return out.(string)
}

// MarshalYAML returns the YAML representation of a DredgerPeriodicVestingAccount.
func (pva DredgerPeriodicVestingAccount) MarshalYAML() (interface{}, error) {
