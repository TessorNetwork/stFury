...
import (
	context "context"
	fmt "fmt"
	types1 "github.com/TessorNetwork/dredger/v4/x/claim/vesting/types"
...
type QueryClaimableForActionRequest struct {
	AirdropIdentifier string `protobuf:"bytes,1,opt,name=airdrop_identifier,json=airdropIdentifier,proto3" json:"airdrop_identifier,omitempty" yaml:"airdrop_identifier"`
	Address           string `protobuf:"bytes,2,opt,name=address,proto3" json:"address,omitempty" yaml:"address"`
	Action            Action `protobuf:"varint,3,opt,name=action,proto3,enum=dredger.claim.Action" json:"action,omitempty" yaml:"action"`
}
...
func init() {
	proto.RegisterType((*QueryDistributorAccountBalanceRequest)(nil), "dredger.claim.QueryDistributorAccountBalanceRequest")
	proto.RegisterType((*QueryDistributorAccountBalanceResponse)(nil), "dredger.claim.QueryDistributorAccountBalanceResponse")
	proto.RegisterType((*QueryParamsRequest)(nil), "dredger.claim.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "dredger.claim.QueryParamsResponse")
	proto.RegisterType((*QueryClaimRecordRequest)(nil), "dredger.claim.QueryClaimRecordRequest")
	proto.RegisterType((*QueryClaimRecordResponse)(nil), "dredger.claim.QueryClaimRecordResponse")
	proto.RegisterType((*QueryClaimableForActionRequest)(nil), "dredger.claim.QueryClaimableForActionRequest")
	proto.RegisterType((*QueryClaimableForActionResponse)(nil), "dredger.claim.QueryClaimableForActionResponse")
	proto.RegisterType((*QueryTotalClaimableRequest)(nil), "dredger.claim.QueryTotalClaimableRequest")
	proto.RegisterType((*QueryTotalClaimableResponse)(nil), "dredger.claim.QueryTotalClaimableResponse")
	proto.RegisterType((*QueryUserVestingsRequest)(nil), "dredger.claim.QueryUserVestingsRequest")
	proto.RegisterType((*QueryUserVestingsResponse)(nil), "dredger.claim.QueryUserVestingsResponse")
}

func init() { proto.RegisterFile("dredger/claim/query.proto", fileDescriptor_baa87682a02846df) }
...
func (c *queryClient) DistributorAccountBalance(ctx context.Context, in *QueryDistributorAccountBalanceRequest, opts ...grpc.CallOption) (*QueryDistributorAccountBalanceResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/dredger.claim.Query/DistributorAccountBalance", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/dredger.claim.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) ClaimRecord(ctx context.Context, in *QueryClaimRecordRequest, opts ...grpc.CallOption) (*QueryClaimRecordResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/dredger.claim.Query/ClaimRecord", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) ClaimableForAction(ctx context.Context, in *QueryClaimableForActionRequest, opts ...grpc.CallOption) (*QueryClaimableForActionResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/dredger.claim.Query/ClaimableForAction", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) TotalClaimable(ctx context.Context, in *QueryTotalClaimableRequest, opts ...grpc.CallOption) (*QueryTotalClaimableResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/dredger.claim.Query/TotalClaimable", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) UserVestings(ctx context.Context, in *QueryUserVestingsRequest, opts ...grpc.CallOption) (*QueryUserVestingsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/dredger.claim.Query/UserVestings", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_DistributorAccountBalance_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dredger.claim.Query/DistributorAccountBalance",
	}
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dredger.claim.Query/Params",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_ClaimRecord_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dredger.claim.Query/ClaimRecord",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_ClaimableForAction_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dredger.claim.Query/ClaimableForAction",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_TotalClaimable_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dredger.claim.Query/TotalClaimable",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_UserVestings_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dredger.claim.Query/UserVestings",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "dredger.claim.Query",
	...
	Metadata: "dredger/claim/query.proto",
}
