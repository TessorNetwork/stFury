...
// source: dredger/claim/claim.proto
...
func init() {
	proto.RegisterEnum("dredger.claim.Action", Action_name, Action_value)
	proto.RegisterType((*ClaimRecord)(nil), "dredger.claim.ClaimRecord")
}

func init() { proto.RegisterFile("dredger/claim/claim.proto", fileDescriptor_b4747d999b9dc0da) }
