...
func init() {
	proto.RegisterType((*MsgSetAirdropAllocations)(nil), "dredger.claim.MsgSetAirdropAllocations")
	proto.RegisterType((*MsgSetAirdropAllocationsResponse)(nil), "dredger.claim.MsgSetAirdropAllocationsResponse")
	proto.RegisterType((*MsgClaimFreeAmount)(nil), "dredger.claim.MsgClaimFreeAmount")
	proto.RegisterType((*MsgClaimFreeAmountResponse)(nil), "dredger.claim.MsgClaimFreeAmountResponse")
	proto.RegisterType((*MsgCreateAirdrop)(nil), "dredger.claim.MsgCreateAirdrop")
	proto.RegisterType((*MsgCreateAirdropResponse)(nil), "dredger.claim.MsgCreateAirdropResponse")
	proto.RegisterType((*MsgDeleteAirdrop)(nil), "dredger.claim.MsgDeleteAirdrop")
	proto.RegisterType((*MsgDeleteAirdropResponse)(nil), "dredger.claim.MsgDeleteAirdropResponse")
}

func init() { proto.RegisterFile("dredger/claim/tx.proto", fileDescriptor_9d435242bf328977) }
...
func (c *msgClient) SetAirdropAllocations(ctx context.Context, in *MsgSetAirdropAllocations, opts ...grpc.CallOption) (*MsgSetAirdropAllocationsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/dredger.claim.Msg/SetAirdropAllocations", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) ClaimFreeAmount(ctx context.Context, in *MsgClaimFreeAmount, opts ...grpc.CallOption) (*MsgClaimFreeAmountResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/dredger.claim.Msg/ClaimFreeAmount", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) CreateAirdrop(ctx context.Context, in *MsgCreateAirdrop, opts ...grpc.CallOption) (*MsgCreateAirdropResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/dredger.claim.Msg/CreateAirdrop", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) DeleteAirdrop(ctx context.Context, in *MsgDeleteAirdrop, opts ...grpc.CallOption) (*MsgDeleteAirdropResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/dredger.claim.Msg/DeleteAirdrop", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_SetAirdropAllocations_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dredger.claim.Msg/SetAirdropAllocations",
	}
...
func _Msg_ClaimFreeAmount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dredger.claim.Msg/ClaimFreeAmount",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_CreateAirdrop_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dredger.claim.Msg/CreateAirdrop",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_DeleteAirdrop_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dredger.claim.Msg/DeleteAirdrop",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "dredger/claim/tx.proto",
}
