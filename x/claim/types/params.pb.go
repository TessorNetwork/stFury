...
// source: dredger/claim/params.proto
...
func init() {
	proto.RegisterType((*Params)(nil), "dredger.claim.Params")
	proto.RegisterType((*Airdrop)(nil), "dredger.claim.Airdrop")
}

func init() { proto.RegisterFile("dredger/claim/params.proto", fileDescriptor_dd7ac871d3875dc3) }
