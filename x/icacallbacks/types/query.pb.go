...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "dredger.icacallbacks.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "dredger.icacallbacks.QueryParamsResponse")
	proto.RegisterType((*QueryGetCallbackDataRequest)(nil), "dredger.icacallbacks.QueryGetCallbackDataRequest")
	proto.RegisterType((*QueryGetCallbackDataResponse)(nil), "dredger.icacallbacks.QueryGetCallbackDataResponse")
	proto.RegisterType((*QueryAllCallbackDataRequest)(nil), "dredger.icacallbacks.QueryAllCallbackDataRequest")
	proto.RegisterType((*QueryAllCallbackDataResponse)(nil), "dredger.icacallbacks.QueryAllCallbackDataResponse")
}

func init() { proto.RegisterFile("dredger/icacallbacks/query.proto", fileDescriptor_5e73b99abb7e91c2) }
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/dredger.icacallbacks.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) CallbackData(ctx context.Context, in *QueryGetCallbackDataRequest, opts ...grpc.CallOption) (*QueryGetCallbackDataResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/dredger.icacallbacks.Query/CallbackData", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) CallbackDataAll(ctx context.Context, in *QueryAllCallbackDataRequest, opts ...grpc.CallOption) (*QueryAllCallbackDataResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/dredger.icacallbacks.Query/CallbackDataAll", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dredger.icacallbacks.Query/Params",
	}
...
func _Query_CallbackData_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dredger.icacallbacks.Query/CallbackData",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_CallbackDataAll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dredger.icacallbacks.Query/CallbackDataAll",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "dredger.icacallbacks.Query",
	...
	Metadata: "dredger/icacallbacks/query.proto",
}
