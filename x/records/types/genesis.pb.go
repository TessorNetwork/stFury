...
// source: dredger/records/genesis.proto
...
const (
	DepositRecord_DREDGER         DepositRecord_Source = 0
...
type DepositRecord struct {
	...
	Status             DepositRecord_Status                   `protobuf:"varint,6,opt,name=status,proto3,enum=dredger.records.DepositRecord_Status" json:"status,omitempty"`
	...
	Source             DepositRecord_Source                   `protobuf:"varint,8,opt,name=source,proto3,enum=dredger.records.DepositRecord_Source" json:"source,omitempty"`
}
...
type HostZoneUnbonding struct {
	...
	Status                HostZoneUnbonding_Status               `protobuf:"varint,6,opt,name=status,proto3,enum=dredger.records.HostZoneUnbonding_Status" json:"status,omitempty"`
...
func init() {
	proto.RegisterEnum("dredger.records.DepositRecord_Status", DepositRecord_Status_name, DepositRecord_Status_value)
	proto.RegisterEnum("dredger.records.DepositRecord_Source", DepositRecord_Source_name, DepositRecord_Source_value)
	proto.RegisterEnum("dredger.records.HostZoneUnbonding_Status", HostZoneUnbonding_Status_name, HostZoneUnbonding_Status_value)
	proto.RegisterType((*UserRedemptionRecord)(nil), "dredger.records.UserRedemptionRecord")
	proto.RegisterType((*Params)(nil), "dredger.records.Params")
	proto.RegisterType((*RecordsPacketData)(nil), "dredger.records.RecordsPacketData")
	proto.RegisterType((*NoData)(nil), "dredger.records.NoData")
	proto.RegisterType((*DepositRecord)(nil), "dredger.records.DepositRecord")
	proto.RegisterType((*HostZoneUnbonding)(nil), "dredger.records.HostZoneUnbonding")
	proto.RegisterType((*EpochUnbondingRecord)(nil), "dredger.records.EpochUnbondingRecord")
	proto.RegisterType((*GenesisState)(nil), "dredger.records.GenesisState")
}

func init() { proto.RegisterFile("dredger/records/genesis.proto", fileDescriptor_98cfd0253c8b6797) }
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "dredger.records.Msg",
	HandlerType: (*MsgServer)(nil),
	Methods:     []grpc.MethodDesc{},
	Streams:     []grpc.StreamDesc{},
	Metadata:    "dredger/records/genesis.proto",
}
