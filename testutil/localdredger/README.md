...
- Example: `dred tx bank send ls-test2 dredger1kwax6g0q2nwny5n43fswexgefedge033t5g95j --keyring-backend test --chain-id localdredger`
...
```sh
dred tx bank send val dredger1qym804u6sa2gvxedfy96c0v9jc0ww7593uechw 10000000udred --chain-id localdredger --keyring-backend test
```
